                    ...
                    <div class="grid grid-cols-1 lg:h-screen lg:grid-cols-2">
                        ...
                        <div class="relative flex items-center bg-gray-100">
                            ...
                            <div class="p-8 sm:p-16 lg:p-24">
                                <h2 class="text-2xl font-bold sm:text-3xl">Lorem ipsum dolor sit amet,consectectur adisisicing elit. Tempore, debitis.</h2>
                                <p class="mt-4 text-gray-600">"Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vero minus quaerat delectus obcaecati dolore culpa, impedit pariatur dolorem error suscipit quidem corrupti quam exercitationem vel? Adipisci esse aperiam doloremque accusantium.</p>
